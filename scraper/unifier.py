...
dates = scrapper.generateDates(start=begin, end=end, dateFormat=dateFormat)
...
commentsFilesNames = [ "{rootPath}/{media}/{date}-comments.json".format(rootPath=resultPath, media=media, date=d) for d in dates ]
contentsFilesNames = [ "{rootPath}/{media}/{date}-contents.json".format(rootPath=resultPath, media=media, date=d) for d in dates ]

totalCommentsArr = loadJsons(commentsFilesNames)
totalContentsArr = loadJsons(contentsFilesNames)

comments_file_unified = "{rootPath}/{media}/{media}-{period}-comments.csv".format(rootPath=resultPath, media=media, period=period)
contents_file_unified = "{rootPath}/{media}/{media}-{period}-contents.csv".format(rootPath=resultPath, media=media, period=period)
